<template>
	<view>
						...
						<view class="page-box">
							<view class="order" v-for="(res, index) in dataList" :key="res.id" >
								...
								<view class="bottom">
									...
									<view class="evaluate btn" @click="likeArticle(res.id)">
										<u-icon name="thumb-up"></u-icon>{{res.likes}}
										
									</view>
									<view class="more" @click="goToDetail(res)">
		...
		<view class="add">
			<u-icon name="plus-circle-fill" color="#dba58b" size="100" @click="gotoAdd()"></u-icon><br><br>
			<u-icon name="heart-fill" color="#dba58b" size="100" @click="gotoMy()"></u-icon>
		</view>
...
<script>
	import { getAllArticle,likes } from '../../api/article.js'
		...
		data() {
			return {
				...
				dataList: [{
						...
						title: '【冬日限定】现货 原创jk制服女2百搭日系甜美风',
						type: 0,
						content: '付款后30天内发货冬日限定】现货 原创jk制服女2020冬装新款小清新宽松软糯毛衣外套女开衫短款百搭日系甜美风',
						fileId: '348.58',
						likes: 2

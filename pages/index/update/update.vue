		...
		<view class="acontent">
			<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
				<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" label-width="120" :label-position="labelPosition"
				 label="标题" prop="title">
					<u-input :border="border" v-model="model.title" type="text"></u-input>
				</u-form-item>
				...
				<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" label-width="120" :label-position="labelPosition"
				 label="内容" prop="title">
					<editor id="editor" class="ql-container"  @ready="onEditorReady" v-model="model.content"></editor>
				</u-form-item>
			...
			submit() {
				...
				this.$refs.uForm.validate(valid => {
					...
					if (valid) {
						...
						updateArticle(this.requestParameters).then(res => {
							console.log(res)
						}).catch(res => {
							console.log(res)
						})

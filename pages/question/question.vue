<template>
	<view>
			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition">
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<view class="order" v-for="(res, index) in dataList" :key="res.id" @click="goToDetail(res)">
		...
		<view class="add">
			<u-icon @click="gotoAdd()" name="plus-circle-fill" color="#dba58b" size="100"></u-icon><br><br>
			<u-icon @click="gotoMy()" name="question-circle-fill" color="#dba58b" size="100"></u-icon><br><br>
			<u-icon @click="gotoMyAnswer()" name="chat-fill" color="#dba58b" size="100"></u-icon>
		</view>

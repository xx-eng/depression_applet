			...
			<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
				...
				<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" label-width="120" :label-position="labelPosition"
				 label="内容" prop="title">
					...
					<textarea class="ql-container" v-model="model.answer" placeholder="请输入问题答案" />
					</u-form-item>
...
<script>
	import {addAnswer} from '../../../api/question.js'
			...
			submit() {
				...
				this.$refs.uForm.validate(valid => {
					...
					if (valid) {
						...
						this.requestParameters = Object.assign({},other, this.model)
						console.log('requestParam', this.requestParameters)
						addAnswer(this.requestParameters).then(res => {
							console.log(res)
						}).catch(res => {
							console.log(res)
						})
